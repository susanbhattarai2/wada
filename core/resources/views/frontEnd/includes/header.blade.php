            ...
            <div>
                            ...
                            <div class="btn-group header-dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @if(Auth::user()->permissions ==0 || Auth::user()->permissions ==1)
                                        <a class="dropdown-item"
                                           href="http://digimednepal.com/lalitpurwada/admin/10/topics"> <i
                                                class="fa fa-user"></i>Citizen Data</a>
                                    @endif
                                    @if(Auth::user()->permissions ==0 || Auth::user()->permissions ==1)
                                        <a class="dropdown-item"
                ...
                <div class="pull-left">
                    ...
                    <i class="fa fa-exclamation-triangle"></i> &nbsp;<a
                                href="https://covid19.mohp.gov.np/" target="_blank">Alert Covid-19</a>
                    </span>
                    <span class="top-email">
                        &nbsp; | &nbsp;
                    <i class="fa fa-bolt"></i> &nbsp;<a
                                href="#" target="_blank">Weather Forcast</a>
                    </span>
                    <span class="top-email">
                        &nbsp; | &nbsp;
                    <i class="fa fa-ambulance"></i> &nbsp;<a
                                href="#" target="_blank">Ambulance</a>
                    </span>
                    <span class="top-email">
                        &nbsp; | &nbsp;
                    <i class="fa fa-hotel"></i> &nbsp;<a
                                href="#" target="_blank">Hospitals</a>
                    </span>
                    <span class="top-email">
                        &nbsp; | &nbsp;
                    <i class="fa fa-coffee"></i> &nbsp;<a
                                href="#" target="_blank">Hotels</a>
                    </span>
                </div>
            </div>
        </div>
