...
@section('content')
    ...
    <a class="weatherwidget-io" href="https://forecast7.com/en/27d6685d32/patan/" data-label_1="LALITPUR" data-label_2="WEATHER" data-theme="original" >LALITPUR WEATHER</a>
<script>
    ...
    @if(!empty($HomePage))
        @if(@$HomePage->{"details_" . @Helper::currentLanguage()->code} !="")
            <section class="content-row-no-bg home-welcome">
                <div class="container">
                    <div class="row">
                          <div class="col-lg-9"><!-- start Home Slider -->
